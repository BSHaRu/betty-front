									...
									<tbody>
										...
										<tr>
											...
											<td><a href="#" class="view" title="View"
												data-toggle="tooltip"> <i class="bi bi-book"></i></a></td>
											<td><a href="#" class="reserve" title="Reserve"
												data-toggle="tooltip"> <i class="bi bi-bookmark-check"></i>
													<i class="bi bi-bookmark-check-fill"></i>
											</a> <a href="#" class="delete" title="Delete"
												data-toggle="tooltip"> <i class="bi bi-trash"></i></a></td>
										</tr>
										<!-- 2 -->
										<tr>
											<td>2</td>
