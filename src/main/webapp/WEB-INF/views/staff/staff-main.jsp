    	...
    	<div class="card mb-3 h-120" style="max-width: 350px;">
					<div class="row no-gutters">
						...
						<div class="col-md-8">
							...
							<div class="row">
								<label for="val1">이름 : </label>
								<input type="text" id="val1" value="&nbsp;{nameasdf}" readonly> 
							</div>
							<div class="row">
								<label for="val1">이름 : </label>
								<input type="text" id="val1" value="&nbsp;{name}" readonly> 
							</div>
							<div class="row">
								<label for="val1">이름 : </label>
								<input type="text" id="val1" value="&nbsp;{name}" readonly> 
  ...
  <div class="col mb-4">
    	<div class="card mb-3 h-120" style="max-width: 350px;">
					<div class="row no-gutters">
						...
						<div class="col-md-8">
							<div class="card-body" id="cardText">
								<input type="text" value="{값 예시 1번}"> 
								<input type="text" value="{값 예시 2번}">
								<input type="text" value="{값 예시 3번}">
								<input type="text" value="{값 예시 4번}">
								<input type="text" value="{값 예시 5번}">
								<p class="card-text">
